...
const ProjectsSection = () => {
  ...
  return (
    <section id="projects" className="py-20 section-padding" ref={ref}>
      <div className="container-width">
        ...
        >
          {projects.map((project, index) => (
            ...
            >
              <div className="glass-effect rounded-xl p-6 h-full relative overflow-hidden transition-all duration-500 hover:glow-effect">
                ...
                <div className="relative z-10 space-y-4 h-full flex flex-col">
                  ...
                  <motion.div 
                    className="glass-effect border border-primary/20 rounded-lg p-4 flex-grow"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.technologies.map((tech, techIndex) => (
                        <motion.span
                          key={techIndex}
                          className="px-3 py-1 bg-gradient-to-r from-purple-500/20 to-blue-500/20 text-foreground text-xs rounded-full border border-primary/30"
                  ...
                  >
                    <Button
                      variant="outline"
                      className="w-full group-hover:bg-gradient-to-r group-hover:from-purple-600 group-hover:to-blue-600 group-hover:text-white transition-all duration-300"
